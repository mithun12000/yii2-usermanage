...
/**
 * SysparamsTrashSearch represents the model behind the search form about `mithun\parametricfilter\models\SystemParams`.
 */
class SysparamsTrashSearch extends SystemParams
{
    /**
     * @inheritdoc
     */
