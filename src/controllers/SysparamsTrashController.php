...
use mithun\usermanage\models\SysparamsTrashSearch;
...
/**
 * SysparamsTrashController implements the CRUD actions for SystemParams model.
 */
class SysparamsTrashController extends AccessController
{
    ...
    {
        $searchModel = new SysparamsTrashSearch();
